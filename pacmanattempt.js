...
function checkPageBounds(direction, imgWidth, pos, pageWidth) {
  ...
  //if the direction of pacman is equal to 0, 
  //and position + image width (200) is greater than pagewidth(your window screen width)
  //then the direction moves continuously
  if (direction == 1 && pos < 0) direction = 0;
  //if direction is equal to 1 
  //and position is less than 0,
  //then direction reverses.
  return direction; //return its direction
}
